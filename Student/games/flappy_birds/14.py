...
values_frame.grid(row=0, column=0, padx=10, pady=10)
...
check1.grid(row=1, column=0, sticky="w", padx=10)

check2 = CTkCheckBox(values_frame, text="value 2")
check2.grid(row=2, column=0, sticky="w", padx=10)

check3 = CTkCheckBox(values_frame, text="value 3")
check3.grid(row=3, column=0, sticky="w", padx=10)
